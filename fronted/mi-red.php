    ...
    <main>
        ...
        <div class="collapse" id="collapseExample">
            <section class="row justify-content-center" style="background-color: #E1E9EE; margin-bottom: 2.3rem;">
                <div class="container-fluid" id="mensaje-bienvenida">
                    <p>
                        <h5 style="font-weight: 499;"><?php echo $_COOKIE["nombre"]?>, completa estos pasos para sacar todo el provecho de LinkedIn.</h5>
                    </p>
                </div>
                <div class="card bg-light ml-0 mr-0 mb-4 mt-0"
                    style="width: 25rem; height: 12.5rem; text-align: center;">
                    <div class="card-body cols-3">
                        <br><img src="img/svg/añadir_empresa.svg"><br>
                        <br>
                        <h6 class="card-title">Añade tu empresa más reciente a tu perfil</h6>
                    </div>
                </div>
                <div class="card bg-light ml-0 mr-0 mb-4 mt-0"
                    style="width: 25rem; height: 12.5rem; text-align: center;">
        ...
        <section class="row justify-content-center mt-2">
            <div class="col-3.5">
                <div class="container-fluid">
                    <div class="card mb-2 shadow-sm" style="width: 310px !important;">
                        <div class="card-header" style="padding: 0 20px; height: 46px;">
                            <button class="btn post-nuevo btn-sm" style="font-size: 1rem;">Gestionar Mi Red.</button>
                        </div>
                        <div class="card-body" style="padding: 0 25px;">
                            <button class="btn post-nuevo btn-sm" style="font-size: 1rem; color: #181818;"><i class="far fa-address-book"></i> Contactos</button>
                            <button class="btn post-nuevo btn-sm" style="font-size: 1rem; color: #181818;"><i class="fas fa-user-friends"></i> Gente que sigo</button>
                            <button class="btn post-nuevo btn-sm" style="font-size: 1rem; color: #181818;"><i class="far fa-calendar-alt"></i> Eventos</button>
                            <button class="btn post-nuevo btn-sm" style="font-size: 1rem; color: #181818;"><i class="far fa-file-alt"></i> Páginas</button>
                            <button class="btn post-nuevo btn-sm" style="font-size: 1rem; color: #181818;"><i class="far fa-newspaper"></i> Newsletters</button>
                            <button class="btn post-nuevo btn-sm" style="font-size: 1rem; color: #181818;"><i class="fas fa-hashtag"></i> Hashtags</button>
                        </div>
                        <div class="card-footer px-2 py-2" style="padding-top: .8rem !important;">
                            <a href="empleos.php"><img src="img/ver_empleo.png" style="width: auto;"></a>
                        </div>
                        <div class="card-footer px-2 py-2" style="text-align: center;">
                            <a href="#">Amplía tu red</a>
                        </div>
                    ...
                    <div class="row mb-1">
                        <div class="container-fluid">
                            <div class="card mb-2 shadow-sm">
                                <div class="card-header" style="padding: 8px 25px;">
                                    <button class="btn post-nuevo btn-sm" style="font-size: 1rem;">Siguiendo: 4</button>
                                </div>
                                <!--seccion de usuarios siguiendo-->
                                <div class="card-body px-0 py-0" style="padding: 6px 15px !important; margin-right: auto; margin-left: auto;">
                                    <div class="form-row" style="width: 100%; margin-right: auto; margin-left: auto;">
                                        <div class="col-3 ml-2" style="border-width: 2px; border-color: black; flex: 0 0 20%; max-width: 60%;">
                                            <div class="card-header">
                                                <img class="img-fluid img-thumbnail rounded-circle" id="img-perfil-usuario" style="max-width: 150px !important;" src="img/perfil-usuario/2.png">
                                            </div>
                                            <div class="card-body">
                                                <b>Google Business</b>
                                            </div>
                                            <div class="card-footer">
                                                <button class="btn btn-outline-primary" style="padding: 5px;"><i class="fas fa-check"></i> Siguiendo</button>
                                            </div>
                                        </div>
                                        <div class="col-3 ml-2" style="border-width: 2px; border-color: black; flex: 0 0 20%; max-width: 60%;">
                                            <div class="card-header">
                                                <img class="img-fluid img-thumbnail rounded-circle" id="img-perfil-usuario" style="max-width: 150px !important;" src="img/perfil-usuario/5.png">
                                            </div>
                                            <div class="card-body">
                                                <b>Facebook Business</b>
                                            </div>
                                            <div class="card-footer">
                                                <button class="btn btn-outline-primary" style="padding: 5px;"><i class="fas fa-check"></i> Siguiendo</button>
                                            </div>
                                        ...
                                        <div class="col-3 ml-2" style="border-width: 2px; border-color: black; flex: 0 0 20%; max-width: 60%;">
                                            <div class="card-header">
                                                <img class="img-fluid img-thumbnail rounded-circle" id="img-perfil-usuario" style="max-width: 150px !important;" src="img/perfil-usuario/6.png">
                                            </div>
                                            <div class="card-body">
                                                <b>Lourdes Santos</b>
                                            </div>
                                        ...
                                        <div class="col-3 ml-2" style="border-width: 2px; border-color: black; flex: 0 0 20%; max-width: 60%;">
                                            <div class="card-header">
                                                <img class="img-fluid img-thumbnail rounded-circle" id="img-perfil-usuario" style="max-width: 150px !important;" src="img/perfil-usuario/7.png">
                                            </div>
                                            <div class="card-body">
                                                <b>Adela Elvir</b>
                                            </div>
                            ...
                            <!--seccion de usuarios que me siguen-->
                            <div class="card mb-3 shadow-sm">
                                <div class="card-header" style="padding: 8px 25px;">
                                    <button class="btn post-nuevo btn-sm" style="font-size: 1rem;">6 Seguidores</button>
                                </div>
                                <div class="card-body px-0 py-0" style="padding: 6px 15px !important; margin-right: auto; margin-left: auto;">
                                    <div class="form-row" style="width: 100%; margin-right: auto; margin-left: auto;">
                                        <div class="col-3 ml-2" style="border-width: 2px; border-color: black; flex: 0 0 20%; max-width: 60%;">
                                        ...
                                        <div class="col-3 ml-2" style="border-width: 2px; border-color: black; flex: 0 0 20%; max-width: 60%;">
                                            <div class="card-header">
                                                <img class="img-fluid img-thumbnail rounded-circle" id="img-perfil-usuario" style="max-width: 150px !important;" src="img/perfil-usuario/4.png">
                                            </div>
                                            <div class="card-body">
                                                <b>Mario Perez</b>
                                            </div>
                                            <div class="card-footer">
                                                <button class="btn btn-outline-primary" style="padding: 5px;"><i class="fas fa-plus"></i> Seguir</button>
                                            </div>
                                        </div>
                                        <div class="col-3 ml-2" style="border-width: 2px; border-color: black; flex: 0 0 20%; max-width: 60%;">
                                            <div class="card-header">
                                        ...
                                        <div class="col-3 ml-2" style="border-width: 2px; border-color: black; flex: 0 0 20%; max-width: 60%;">
                                            <div class="card-header">
                                                <img class="img-fluid img-thumbnail rounded-circle" id="img-perfil-usuario" style="max-width: 150px !important;" src="img/perfil-usuario/8.png">
                                            </div>
                                            <div class="card-body">
                                                <b>Pedro Santos</b>
                                            </div>
