...
<body style="background-color: #F5F5F5;">   
    ...
    <!-- Ventana Modal para crear un nuevo post o publicacion -->
    <div class="modal fade" id="nuevo-post" tabindex="-1" role="dialog" aria-labelledby="#Label" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="#Label">Crea una publicación</h5>
                ...
                <div class="modal-body">
                    <div class="container">
                        <div class="row">
                            <div class="col-12">
                                <span><img class="img-fluid img-thumbnail rounded-circle" id="img-perfil-usuario" style="max-width:  50px !important;" src=<?php echo $_COOKIE["imagen"]?>><b><?php echo " ".$_COOKIE["nombre"]." ".$_COOKIE["apellido"]?></b></span>
                                <textarea style="margin-top: 5px; border: 0; padding: 12px;" cols="56" rows="7" id="contenido-post" placeholder="¿Sobre qué quieres hablar?" maxlength="150"></textarea>
                                <input id="imagen-post" type="text" class="form-control" placeholder="Ingrese la url de una imagen para su publicación o post."> 
                            </div>
                        </div>
                    </div>
                </div>
                <div class="modal-footer" style="padding: 12px 27px;">
                    <button class="btn post-nuevo btn-sm" style="width: 88px; text-align: center; font-weight: 640; font-size: .95rem"><i class="fas fa-plus" style="color: #3D3D3D;"></i></button>
                    <button class="btn post-nuevo btn-sm" style="width: 88px; text-align: center; font-weight: 640; font-size: .95rem"><i class="fas fa-camera-retro" style="color: #3D3D3D;"></i></button>
                    <button class="btn post-nuevo btn-sm" style="width: 88px; text-align: center; font-weight: 640; font-size: .95rem"><i class="fas fa-video" style="color: #3D3D3D;"></i></button>
                    <button class="btn post-nuevo btn-sm" style="width: 88px; text-align: center; font-weight: 640; font-size: .95rem"><i class="fas fa-file-alt" style="color: #3D3D3D;"></i></button>
                    <button type="button" class="btn btn-primary" id="btn-enviar" onclick="guardarPost()">Publicar</button>
                </div>
            </div>
        </div>
    </div>
        ...
        <section class="row justify-content-center mt-2">
            ...
            <div class="col-2" style="padding: 5px !important;">
                <div class="container-fluid">
                    <div class="row mb-3">
                        <div class="col border bg-light" style="height: 410px;">
                            <div class="container p-2" style="text-align: center;">
                                <div class="row justify-content-center">
                                    <div class="col" id="perfil-usuario">
                                        <img class="img-fluid img-thumbnail rounded-circle" id="img-perfil-usuario" src=<?php echo $_COOKIE["imagen"]?>>
                                        <h6 style="padding-top: 7px;">¡Te damos la bienvenida, <?php echo $_COOKIE["nombre"]?>!</h6> 
                                        <a href="#" style="font-size: .8rem;">Añade una foto</a>
                                    </div>
                                </div>
                                <hr>
                                <div class="row justify-content-center col">
                                    <a href="#" style="text-align: justify; margin-right: auto; font-size: .75rem; box-sizing: inherit; font-weight: 600;">
                                        <span style="color: rgba(0,0,0,.6);">Contactos</span><br>
                                        <span class="titulo" style="color: rgba(0,0,0,.9);">Amplía Tu Red</span>
                                    </a><br><br>
                                    <a href="#" style="text-align: justify; margin-right: auto; font-size: .75rem; box-sizing: inherit; font-weight: 600;">
                                        <span style="color: rgba(0,0,0,.55); font-size: .7rem;">Accede a información y herramientas exclusivas</span><br>
                                        <span class="titulo" style="color: rgba(0,0,0,.9);">Probar Premiun gratis durante 1 mes</span>
                                    </a>  
                                </div>
                                <hr>
                                <div class="row justify-content-center">
                                    <a href="#" style="color: rgba(0,0,0); text-decoration: none;">
                                        <span style="text-align: justify; font-weight: 600;"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" data-supported-dps="16x16" fill="currentColor" width="16" height="16" focusable="false"><path d="M12 1H4a1 1 0 00-1 1v13.64l5-3.36 5 3.36V2a1 1 0 00-1-1zM5 12V3h6v9l-3-2z"></path></svg><span style="font-size: .8rem; text-align: justify;"> Elementos Guardados</span></span>
                                    </a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row justify-content-center">
                        <div class="col border bg-light" style="height: 140px; font-size: .9rem; padding: 12px;">
                            <a href="#">Grupos</a><br>
                            <a href="#" style="text-decoration: none; color:rgba(0,0,0,.8);">Eventos</a><br>
                            <a href="#">Hashtags seguidos</a>
                            <hr>
                            <a href="#" style="color: rgba(0,0,0);">
                                <span style="font-size: .8rem; margin-left: 42px; font-weight: 600;">Descubrir más</span>
                            </a>
                        </div>
                    </div>
                </div>
            ...
            <!-- Sección de Posts o Publicaciones -->
            <div class="col-5.5" style="width: 552px !important;">
                <div class="container-fluid">
                    <!-- NUEVO POST -->
                    <div class="row mb-1">
                        <div class="container-fluid">
                            <div class="card mb-4 shadow-sm" style= "height: 120px;">
                                <div class="card-header" style= "height: 63px; padding: 8px 25px;">
                                    <button href="#" class="btn post-nuevo" data-target="#nuevo-post" data-toggle="modal" style="font-size: 1rem;">
                                    <i class="far fa-edit"></i>   Comienza una publicación.</button>
                                </div>
                                <div class="card-body px-0 py-0" style= "padding: 6px 10px !important;">
                                    <button class="btn post-nuevo btn-sm" style="width: 87px; text-align: center; font-weight: 640; font-size: .95rem"><i class="fas fa-camera-retro" style="color: #33AADA;"></i>  Foto</button>
                                    <button class="btn post-nuevo btn-sm" style="width: 95px; text-align: center; font-weight: 640; font-size: .95rem"><i class="fas fa-video" style="color: #9896F2;"></i>  Vídeo</button>
                                    <button class="btn post-nuevo btn-sm" style="width: 127px; text-align: center; font-weight: 640; font-size: .95rem"><i class="fas fa-file-alt" style="color: #17AFB8;"></i>  Documento</button>
                                    <button class="btn post-nuevo btn-sm" style="width: 157px; text-align: center; font-weight: 640; font-size: .95rem"><i class="fas fa-newspaper" style="color: #EF7E37;"></i>  Escribir artículo</button>
                                </div>
                            </div>
                            <hr>
                        </div>
                    ...
                    <div class="container-fluid">
                        <div class="card mb-2 shadow-sm">
                            <div class="card-header">
                                <div class="row">
                                    <div class="col-2">
                                        <img class="img-fluid img-thumbnail rounded-circle" style="max-width: 64px;" src="img/favicon.ico">
                                    </div>
                                    <div class="col-10" style= "float: left;">    
                                        <b>LinkedIn Marketing Solutions</b>
                                        <p style="font-size: .75rem; margin-bottom: 0 !important; color: #000000bf; font-weight: 640;">4,312.85 seguidores</p>
                                        <p style="font-size: .75rem; margin-bottom: 0 !important; color: #000000bf; font-weight: 640;">Promocionado</p>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body px-0 py-0">
                                <div style="text-align: justify; padding: 8px 13px; font-family: 'Segoe UI', Tahoma, sans-serif;">
                                    <span class="post-content"><b>¡Bienvenid@ a LinkedIn, disfruta de la mejor experiencia, disfruta de LinkedIn!</b></span>
                                </div>
                                <div class="image-post" style="background-image: url(img/posts/27.jpg);"></div>
                            </div>
                        </div>
                    </div>
                    </div>
            ...
            <div class="col-2.5" style="width: 312px !important;">
                <div class="container-fluid">
                    <div class="row mb-3">
                        <div class="col border bg-light" style="height: 308px; padding: 12px;">
                            <p style= "font-weight: 600 !important;">Añadir a tu feed<button class="btn btn-sm" style="margin-left: 130px;"><i class="fas fa-exclamation-circle"></i></button></p>
                            <button class="btn post-nuevo" style="width: 100%; font-weight: 500; height:60px; font-size: .95rem">
                                <img class="img-fluid img-thumbnail rounded-circle" src="img/perfil-usuario/3.png">
                                <b>Microsoft</b>
                                <a href="#" class="btn btn-outline-primary mt-2 mb-1 pt-0" style="height: 30px; border-radius: 0; float: right;" role="button" aria-pressed="true"><i class="fas fa-plus"></i>  Seguir</a>   
                            </button><br><br>
                            <button class="btn post-nuevo" style="width: 100%; font-weight: 500; height:60px; font-size: .95rem">
                                <img class="img-fluid img-thumbnail rounded-circle" src="img/perfil-usuario/4.png">
                                <b>Mario Perez</b>
                                <a href="#" class="btn btn-outline-primary mt-2 mb-1 pt-0" style="height: 30px; border-radius: 0; float: right;" role="button" aria-pressed="true"><i class="fas fa-plus"></i>  Seguir</a>   
                            </button><br><br>
                            <button class="btn post-nuevo" style="width: 100%; font-weight: 500; height:60px; font-size: .95rem">
                                <img class="img-fluid img-thumbnail rounded-circle" src="img/perfil-usuario/8.png">
                                <b>Pedro Santos</b>
                                <a href="#" class="btn btn-outline-primary mt-2 mb-1 pt-0" style="height: 30px; border-radius: 0; float: right;" role="button" aria-pressed="true"><i class="fas fa-plus"></i>  Seguir</a>   
                            </button>
                        </div>
                    ...
                    <div class="row mb-1">
                        ...
                        <p style="font-size: 12px; margin-left: auto; margin-right: auto; margin-top: 10px;"><img src="img/logo.png" style="width= 10px !important;">  LinkedIn Corporation © 2020</p>
                    </div>
                </div>
            </div>
        </section>
